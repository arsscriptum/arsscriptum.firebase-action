...
If you want a more flexible implementation, an early version of a rewrite is available here: [setup-firebase](https://github.com/arsscriptum/setup-firebase) that allows you to choose node and java version and run more than one command.
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to Firebase
        uses: arsscriptum/arsscriptum.firebase-action@live
        with:
